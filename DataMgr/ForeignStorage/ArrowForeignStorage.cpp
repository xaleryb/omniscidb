...
class ArrowForeignStorage : public PersistentForeignStorageInterface {
 public:
  ArrowForeignStorage() {}
...
void ArrowForeignStorage::append(
...
void ArrowForeignStorage::read(const ChunkKey& chunk_key,
                               const SQLTypeInfo& sql_type,
                               int8_t* dest,
...
void ArrowForeignStorage::createDictionaryEncodedColumn(
...
template <typename T, typename ChunkType>
void ArrowForeignStorage::createDecimalColumn(const ColumnDescriptor& c,
                                              std::vector<ArrowFragment>& col,
                                              arrow::ChunkedArray* arr_col_chunked_array,
                                              tbb::task_group& tg,
                                              const std::vector<Frag>& fragments,
